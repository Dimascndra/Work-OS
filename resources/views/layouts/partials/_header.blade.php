...
<div id="kt_header" class="header  header-fixed ">
    ...
    <div class=" container-fluid  d-flex align-items-stretch justify-content-between">
        ...
        <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
            ...
            @endif
            @if (!empty($isNoHeader) && $isNoHeader === true)
            @else
                <!--begin::Header Menu-->
        ...
        <div class="topbar">
            ...
            <div class="dropdown" id="kt_quick_search_toggle">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    ...
                    @include('layouts.partials._extras.dropdown.search-dropdown')
                </div>
                <!--end::Dropdown-->
            </div>
            <!--end::Search-->
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                    <form>
                        <!--[html-partial:include:{"file":"partials/_extras/dropdown/cart.html"}]/-->
                        @include('layouts.partials._extras.dropdown.cart')
                    </form>
                </div>
                <!--end::Dropdown-->
            </div>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                    ...
                    @include('layouts.partials._extras.dropdown.languages')
                </div>
                <!--end::Dropdown-->
            </div>
            <!--end::Languages-->
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    ...
                    @include('layouts.partials._extras.dropdown.user')
                </div>
                <!--end::Dropdown-->
            </div>
            <!--end::User-->
